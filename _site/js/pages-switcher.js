...
"use strict";
    ...
    function init(options) {
        ...
        $('body').append('<div id="page-ajax-loaded" class="page-ajax-loaded animated fadeIn"></div>');
        ajaxLoader();
    ...
    function ajaxLoader() {
        ...
        function showContent() {
            ajaxLoadedContent.removeClass('fadeOut closed');
            ajaxLoadedContent.show();
            $('body').addClass('ajax-page-visible');
        }

        function hideContent() {
            $('#page-ajax-loaded').addClass('fadeOut closed');
